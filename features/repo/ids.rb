...
LOGIN_CANCEL_BUTTON='html/body/div[3]/div/div/form/div[2]/button[1]'
...
ABOUT_BUTTON=".//*[@id='ng-app']/div[1]/nav/div/div/ul[1]/li[3]/a"
MY_SAVED_INNOVATION=".//*[@id='ng-app']/div[2]/div[1]/div[2]/div[1]/div/div[2]/div[2]/div/label/input"
INNOVATIONS=".//*[@id='ng-app']/div[2]/div[1]/div[2]/div[2]/div/div[1]/gl-innovation-card/div/div/div/h3"
SUBMIT_INNOVATION=".//*[@id='ng-app']/div[2]/div/div[2]/div[1]"